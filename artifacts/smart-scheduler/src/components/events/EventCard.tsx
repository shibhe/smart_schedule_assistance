      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h4 className={`text-sm font-medium truncate ${event.completed ? 'line-through text-muted-foreground' : ''}`}>
              {event.title}
            </h4>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0 space-y-1.5">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={handleToggleComplete}>
                      {event.completed ? 'Mark uncompleted' : 'Mark completed'}
                    </DropdownMenuItem>
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-3 pt-2 border-t border-border/50 text-xs text-muted-foreground">
              ...
              <Badge variant="outline" className={`ml-auto capitalize ${priorityColors[event.priority]}`}>
                {event.priority}
              </Badge>
            </div>
          </div>
